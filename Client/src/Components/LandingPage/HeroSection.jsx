      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-[120px] md:pt-[160px]">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-[430px] text-center md:text-left mb-8 md:mb-0">
            ...
            <button className="mt-10 md:mt-[80px] h-16 w-[360px] text-2xl font-bold text-white bg-[#E26307E0] rounded-md hover:bg-opacity-90 transition-colors duration-300">
              Start using the API
            </button>
          </div>
